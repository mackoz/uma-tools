...
- **[docs/thecing-comparison.md](docs/thecing-comparison.md)** — this fork vs. sibling fork `TheCing/uma-tools`: engine/data correctness, V2 and standalone product features, maintenance/deployment tradeoffs, and which base makes more sense for future development.
