...
// inspection horse. (courseimages consumes no skill component at all.) The optional parameter
// is therefore a defensive default for a future consumer with no horse to scale against, not a
// path anything ships today -- if you add a call site, pass a context unless you genuinely have
// no horse.
