...
path, `/Users/william.lu/github/uma-tools-plans/scripts/wq.py` — not through the
`uma-tools/plans/` symlink; see the path-guard warning just below.

| Slot | Local path | GitHub repo | Base branch |
|---|---|---|---|
| engine | `/Users/william.lu/github/uma-tools/uma-skill-tools` | `mackoz/uma-skill-tools` | `master` |
| code | `/Users/william.lu/github/uma-tools` | `mackoz/uma-tools` | `master` |
| plans | `/Users/william.lu/github/uma-tools-plans` | `mackoz/uma-tools-plans` | `main` |
