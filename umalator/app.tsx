...
function App(props) {
	...
	// picker matches what's actually playable; a roster-visibility knob like hideInheritedUniques
	// above, so it also stays out of the umalator-settings share-link blob.
